...
function listarUsuarios() {
  return loadUsers().map(u => ({ email: u.email, nome: u.nome, papel: u.papel, time: u.time || '', calendarId: u.calendarId || '', ativo: u.ativo !== false, cargo: u.cargo || '', cor: u.cor || '' }));
}
...
module.exports = { login, getSession, clearCookie, criarUsuario, listarUsuarios, removerUsuario, redefinirSenha, atualizarUsuario };
