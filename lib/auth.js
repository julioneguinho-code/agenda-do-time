...
function listarUsuarios() {
  return loadUsers().map(u => ({ email: u.email, nome: u.nome, papel: u.papel, time: u.time || '', calendarId: u.calendarId || '', ativo: u.ativo !== false, cargo: u.cargo || '', cor: u.cor || '', metaVenda: +u.metaVenda || 0, master: u.master === true || String(u.email || '').toLowerCase() === 'gestorchama' }));
}
