...
// mesmo segredo forte do módulo de auth (persistido em /data/.secret se APP_SECRET faltar)
let SECRET; try { SECRET = require('./auth').getSecret(); } catch (e) { SECRET = process.env.APP_SECRET || 'troque-este-segredo-na-publicacao'; }
